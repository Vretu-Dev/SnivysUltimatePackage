...
namespace SnivysUltimatePackage.EventHandlers.ServerEventsEventHandlers
{
    public class FreezingTemperaturesEventHandlers
    {
        ...
        private static IEnumerator<float> FreezingTemperaturesTiming()
        {
            ...
            Log.Debug(
                $"Info about SCP-244 that will be used. Scale: {freezing.Scale}, Primed: {freezing.Primed}, Max Diameter {freezing.MaxDiameter} (decently sure this doesnt change the cloud size but idk");
