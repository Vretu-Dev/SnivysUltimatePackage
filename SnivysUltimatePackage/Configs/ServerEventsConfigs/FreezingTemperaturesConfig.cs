...
namespace SnivysUltimatePackage.Configs.ServerEventsConfigs
{
    ...
    public class FreezingTemperaturesConfig
    {
        ...
        [Description(
            "How long before Light Containment Zone gets completely frozen over in seconds after the Time Warning")]
        ...
        public string LightHalfTimeRemainingWarningMessage { get; set; } =
            "5 Minutes before Light Containment Zone Temperature Failure";

        [Description("What should the half time remaining warning be for CASSIE's text in Heavy Containment Zone?")]
        public string LightHalfTimeRemainingWarningText { get; set; } =
            "5 Minutes before Light Containment Zone Temperature Failure";
        ...
        [Description(
            "How long before Heavy Containment Zone gets completely frozen over in seconds AFTER Light Containment Zone's Freeze Over after the Time Warning")]
        ...
        public string HeavyHalfTimeRemainingWarningMessage { get; set; } =
            "2 Minutes 30 Seconds before Heavy Containment Zone Temperature Failure";

        [Description("What should the half time remaining warning be for CASSIE's text in Heavy Containment Zone?")]
        public string HeavyHalfTimeRemainingWarningText { get; set; } =
            "2 Minutes 30 Seconds before Heavy Containment Zone Temperature Failure";
        ...
        [Description(
            "How long before Entrance Zone gets completely frozen over in seconds AFTER Heavy Containment Zone's Freeze Over after the Time Warning")]
        ...
        public string EntranceHalfTimeRemainingWarningMessage { get; set; } =
            "2 Minutes 30 Seconds before Entrance Zone Temperature Failure";

        [Description("What should the half time remaining warning be for CASSIE's text in Entrance Zone?")]
        public string EntranceHalfTimeRemainingWarningText { get; set; } =
            "2 Minutes 30 Seconds before Entrance Zone Temperature Failure";
